...
const Index = () => {
  // Data de fim da promoção: 28 de janeiro (quarta-feira) às 23:59 no horário de Brasília
  const promoEndDate = new Date("2026-01-28T23:59:59-03:00");
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        "Sim! Esta é uma oferta exclusiva válida apenas até quarta-feira (28/01) às 23:59. Após esse horário, a promoção será encerrada definitivamente.",
    },
    {
      question: "O que acontece se eu não aproveitar essa oferta?",
      answer:
        "Esta é uma oportunidade única e irrepetível. Você perderá a chance de ter acesso vitalício por apenas R$ 750,00. Após quarta-feira (28/01) às 23:59, essa oferta especial não estará mais disponível.",
    },
    {
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <ScrollReveal>
            ...
            <p className="text-xl text-muted-foreground mb-8">
              ...
              está se definindo <span className="text-foreground font-semibold">agora</span>. Oferta válida até quarta-feira (28/01) às 23:59.
            </p>
          ...
          <ScrollReveal delay={200}>
            <div className="grid md:grid-cols-2 gap-6 mb-12 max-w-2xl mx-auto">
              ...
              <div className="bg-card/50 border border-border rounded-xl p-6 hover:border-primary/50 transition-all duration-300">
                ...
                <div className="text-muted-foreground">Termina 28/01 às 23:59</div>
              </div>
            </div>
          </ScrollReveal>
      ...
      <footer className="py-8 px-4 border-t border-border">
        <div className="max-w-6xl mx-auto text-center text-sm text-muted-foreground">
          ...
          <p className="text-xs">Oferta única e especial. Válida até quarta-feira (28/01) às 23:59.</p>
        </div>
      </footer>
    </div>
  );
